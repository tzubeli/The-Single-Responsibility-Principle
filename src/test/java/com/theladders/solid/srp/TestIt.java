...
import com.theladders.solid.srp.refactor.ApplyController;
import org.junit.*;
...
import com.theladders.solid.srp.refactor.*;
...
public class TestIt
{
  ...
  private void setupController()
  {
    ...
    ResumeManager resumeManager = new ResumeManager(resumeRepository, myResumeManager);
    ApplyManager applyManager = new ApplyManager(jobSearchService, jobApplicationSystem);
